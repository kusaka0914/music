"""
Django settings for music_sns project.
...
ALLOWED_HOSTS = ['harmony-app-sns.herokuapp.com', 'localhost', '127.0.0.1', '0.0.0.0']
...
WSGI_APPLICATION = 'music_sns.wsgi.application'
